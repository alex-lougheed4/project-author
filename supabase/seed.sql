...
-- Insert sample profiles (these will be linked to auth.users when they sign up)
...
INSERT INTO prompts (id, title, summary, author_id, deadline_date, length, created_at, updated_at) VALUES
  ...
  ('gggggggg-gggg-gggg-gggg-gggggggggggg', 'The Sound of Silence', 'In a world where everyone can hear each other''s thoughts, one person discovers they''ve suddenly gone silent. No one can hear their thoughts, and they can''t hear anyone else''s.', '22222222-2222-2222-2222-222222222222', NOW() + INTERVAL '25 days', 1200, NOW(), NOW()),
  
  ('hhhhhhhh-hhhh-hhhh-hhhh-hhhhhhhhhhhh', 'The Last Laugh', 'A comedian who''s never told a successful joke discovers that their failed jokes are actually prophecies. Every time they tell a joke that doesn''t get laughs, it comes true.', '33333333-3333-3333-3333-333333333333', NOW() + INTERVAL '40 days', 2200, NOW(), NOW());
...
INSERT INTO votes (id, user_id, prompt_id, story_id, vote_type, created_at, updated_at) VALUES
  ...
  ('gggggggg-7777-8888-9999-aaaaaaaaaaaa', '44444444-4444-4444-4444-444444444444', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', NULL, 'upvote', NOW(), NOW()),
  
  ('hhhhhhhh-8888-9999-aaaa-bbbbbbbbbbbb', '11111111-1111-1111-1111-111111111111', 'cccccccc-cccc-cccc-cccc-cccccccccccc', NULL, 'upvote', NOW(), NOW()),
  ('iiiiiiii-9999-aaaa-bbbb-cccccccccccc', '22222222-2222-2222-2222-222222222222', 'cccccccc-cccc-cccc-cccc-cccccccccccc', NULL, 'upvote', NOW(), NOW()),
  ('jjjjjjjj-aaaa-bbbb-cccc-dddddddddddd', '55555555-5555-5555-5555-555555555555', 'cccccccc-cccc-cccc-cccc-cccccccccccc', NULL, 'upvote', NOW(), NOW()),
  
  ('kkkkkkkk-bbbb-cccc-dddd-eeeeeeeeeeee', '11111111-1111-1111-1111-111111111111', 'dddddddd-dddd-dddd-dddd-dddddddddddd', NULL, 'upvote', NOW(), NOW()),
  ('llllllll-cccc-dddd-eeee-ffffffffffff', '22222222-2222-2222-2222-222222222222', 'dddddddd-dddd-dddd-dddd-dddddddddddd', NULL, 'upvote', NOW(), NOW()),
  ('mmmmmmmm-dddd-eeee-ffff-gggggggggggg', '33333333-3333-3333-3333-333333333333', 'dddddddd-dddd-dddd-dddd-dddddddddddd', NULL, 'upvote', NOW(), NOW()),
  ('nnnnnnnn-eeee-ffff-gggg-hhhhhhhhhhhh', '44444444-4444-4444-4444-444444444444', 'dddddddd-dddd-dddd-dddd-dddddddddddd', NULL, 'upvote', NOW(), NOW()),
  
  ('oooooooo-ffff-gggg-hhhh-iiiiiiiiiiii', '22222222-2222-2222-2222-222222222222', 'eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee', NULL, 'upvote', NOW(), NOW()),
  ('pppppppp-gggg-hhhh-iiii-jjjjjjjjjjjj', '33333333-3333-3333-3333-333333333333', 'eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee', NULL, 'downvote', NOW(), NOW()),
  
  -- Votes on stories
  ('qqqqqqqq-hhhh-iiii-jjjj-kkkkkkkkkkkk', '11111111-1111-1111-1111-111111111111', NULL, 'aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee', 'upvote', NOW(), NOW()),
  ('rrrrrrrr-iiii-jjjj-kkkk-llllllllllll', '33333333-3333-3333-3333-333333333333', NULL, 'aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee', 'upvote', NOW(), NOW()),
  ('ssssssss-jjjj-kkkk-llll-mmmmmmmmmmmm', '44444444-4444-4444-4444-444444444444', NULL, 'aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee', 'upvote', NOW(), NOW()),
  
  ('tttttttt-kkkk-llll-mmmm-nnnnnnnnnnnn', '11111111-1111-1111-1111-111111111111', NULL, 'bbbbbbbb-cccc-dddd-eeee-ffffffffffff', 'upvote', NOW(), NOW()),
  ('uuuuuuuu-llll-mmmm-nnnn-oooooooooooo', '22222222-2222-2222-2222-222222222222', NULL, 'bbbbbbbb-cccc-dddd-eeee-ffffffffffff', 'upvote', NOW(), NOW()),
  ('vvvvvvvv-mmmm-nnnn-oooo-pppppppppppp', '55555555-5555-5555-5555-555555555555', NULL, 'bbbbbbbb-cccc-dddd-eeee-ffffffffffff', 'downvote', NOW(), NOW()),
  
  ('wwwwwwww-nnnn-oooo-pppp-qqqqqqqqqqqq', '22222222-2222-2222-2222-222222222222', NULL, 'cccccccc-dddd-eeee-ffff-gggggggggggg', 'upvote', NOW(), NOW()),
  ('xxxxxxxx-oooo-pppp-qqqq-rrrrrrrrrrrr', '33333333-3333-3333-3333-333333333333', NULL, 'cccccccc-dddd-eeee-ffff-gggggggggggg', 'upvote', NOW(), NOW()),
  ('yyyyyyyy-pppp-qqqq-rrrr-ssssssssssss', '44444444-4444-4444-4444-444444444444', NULL, 'cccccccc-dddd-eeee-ffff-gggggggggggg', 'upvote', NOW(), NOW()),
  ('zzzzzzzz-qqqq-rrrr-ssss-tttttttttttt', '55555555-5555-5555-5555-555555555555', NULL, 'cccccccc-dddd-eeee-ffff-gggggggggggg', 'upvote', NOW(), NOW()),
  
  ('11111111-rrrr-ssss-tttt-uuuuuuuuuuuu', '11111111-1111-1111-1111-111111111111', NULL, 'dddddddd-eeee-ffff-gggg-hhhhhhhhhhhh', 'upvote', NOW(), NOW()),
  ('22222222-ssss-tttt-uuuu-vvvvvvvvvvvv', '22222222-2222-2222-2222-222222222222', NULL, 'dddddddd-eeee-ffff-gggg-hhhhhhhhhhhh', 'upvote', NOW(), NOW()),
  ('33333333-tttt-uuuu-vvvv-wwwwwwwwwwww', '44444444-4444-4444-4444-444444444444', NULL, 'dddddddd-eeee-ffff-gggg-hhhhhhhhhhhh', 'upvote', NOW(), NOW()),
  
  ('44444444-uuuu-vvvv-wwww-xxxxxxxxxxxx', '11111111-1111-1111-1111-111111111111', NULL, 'eeeeeeee-ffff-gggg-hhhh-iiiiiiiiiiii', 'upvote', NOW(), NOW()),
  ('55555555-vvvv-wwww-xxxx-yyyyyyyyyyyy', '33333333-3333-3333-3333-333333333333', NULL, 'eeeeeeee-ffff-gggg-hhhh-iiiiiiiiiiii', 'upvote', NOW(), NOW()),
  ('66666666-wwww-xxxx-yyyy-zzzzzzzzzzzz', '44444444-4444-4444-4444-444444444444', NULL, 'eeeeeeee-ffff-gggg-hhhh-iiiiiiiiiiii', 'upvote', NOW(), NOW()),
  ('77777777-xxxx-yyyy-zzzz-111111111111', '55555555-5555-5555-5555-555555555555', NULL, 'eeeeeeee-ffff-gggg-hhhh-iiiiiiiiiiii', 'upvote', NOW(), NOW());
